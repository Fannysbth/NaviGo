...
namespace UI_NaviGO
{
    public partial class UserSuccess : Form
    {
        ...
        private void BuildUI()
        {
            ...
            {
                Size = new Size(600, 500), // Diperbesar untuk tombol tambahan
            ...
            // ===== TOMBOL KIRIM E-TICKET =====
            Button btnKirimEmail = new Button()
            {
                Text = "Kirim E-Ticket via Email",
                Font = new Font("Segoe UI", 12, FontStyle.Bold),
                BackColor = Color.FromArgb(255, 204, 153),
                ForeColor = Color.FromArgb(0, 85, 92),
                FlatStyle = FlatStyle.Flat,
                Size = new Size(250, 50),
                Location = new Point((mainPanel.Width - 260) / 2, 290)
            };
            btnKirimEmail.FlatAppearance.BorderSize = 0;
